...
with app.app_context():
    ...
    p1 = Property(address='988 eastern parkway', neighborhood='crown heights', borough='brooklyn', number_of_bedrooms=2, price=1600, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
    p2 = Property(address='11 broadway', neighborhood='financial district', borough='manhattan', number_of_bedrooms=10, price=10000, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
    p3 = Property(address='190 Beach 69th St', neighborhood='arvene', borough='queens', number_of_bedrooms=3, price=3000, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
    p4 = Property(address='2445 third avenue', neighborhood='bronx', borough='bronx', number_of_bedrooms=3, price=2000, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
    p5 = Property(address='1135 pelham pkwy', neighborhood='pelham bay', borough='bronx', number_of_bedrooms=3, price=3000, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
    p6 = Property(address='168 Avenue B', neighborhood='east village', borough='manhattan', number_of_bedrooms=2, price=4100, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
    p7 = Property(address='233 9th ave', neighborhood='chelsea', borough='manhattan', number_of_bedrooms=1, price=3500, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
    p8 = Property(address='140 Frost St', neighborhood='williamsburg', borough='brooklyn', number_of_bedrooms=2, price=4350, img_url='https://photos.zillowstatic.com/fp/d09877650d85468ebb04422aaed0b022-p_e.webp')
